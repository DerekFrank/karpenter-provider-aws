...
// WithReservationID scopes a reserved-offering cache entry to a specific capacity reservation, so an interruption or ICE
// on one reservation doesn't mark other reservations sharing the same instance type + zone unavailable.
